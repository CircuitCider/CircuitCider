use bevy::prelude::*;
use bevy_mod_picking::{focus::PickingInteraction, picking_core::Pickable, selection::PickSelection};

/// de-select clicked selected things.
pub fn deselect_clicked(
    mut selectables: Query<(&mut PickSelection, &PickingInteraction)>
) {
